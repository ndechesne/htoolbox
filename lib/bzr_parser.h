...
// Parser for Bazaar control directory '.bzr'
class BzrControlParser : public Parser {
public:
  // Just to know the parser used
  string name() const;
