...
int main(void) {
  ...
  out(info, "default level", -1, NULL);
  out(alert, "alert level", -1, NULL);
  out(alert, "alert 0 level", 0, NULL);
  out(error, "error level", -1, NULL);
  out(error, "error 0 level", 0, NULL);
  out(warning, "warning level", -1, NULL);
  out(warning, "warning 0 level", 0, NULL);
  out(warning, "warning 1 level", 1, NULL);
  out(warning, "warning 2 level", 2, NULL);
  out(info, "info level", -1, NULL);
  out(info, "info 0 level", 0, NULL);
  out(info, "info 1 level", 1, NULL);
  out(info, "info 2 level", 2, NULL);
  out(verbose, "verbose level", -1, NULL);
  out(verbose, "verbose 0 level", 0, NULL);
  out(verbose, "verbose 1 level", 1, NULL);
  out(verbose, "verbose 2 level", 2, NULL);
  out(debug, "debug level", -1, NULL);
  out(debug, "debug 0 level", 0, NULL);
  out(debug, "debug 1 level", 1, NULL);
  out(debug, "debug 2 level", 2, NULL);
  ...
  out(info, "", -3, NULL);
  out(info, "Short line", -3, NULL);
  out(info, "A longer line", -3, NULL);
  out(info, "Tiny one", -3, NULL);
  out(info, ".", -3, NULL);
  out(info, "A longer line", -3, NULL);
  out(info, "An even longer line", -3, NULL);
  out(info, "A normal line", -1, NULL);
