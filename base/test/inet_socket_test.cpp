...
void* server_thread(void* user) {
  InetSocket& master_server = *static_cast<InetSocket*>(user);
  InetSocket server(master_server);
...
int main() {
  ...
  InetSocket server(12345, "0.0.0.0");
  ...
  InetSocket client2(12345, "127.0.0.1");
